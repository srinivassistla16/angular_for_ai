...
currencyConversionToolCall(simpleQuery: SimpleQuery): Observable<any> {
  return this.http.post<any>(this.apiUrl + "/toolcallingcomplex/currencyconversion", simpleQuery);
}
}